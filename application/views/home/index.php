      ...
      if(res.status == 'ok'){
        ...
        for (var i = 0; i < contractors.length; i++) {
          a += '<a href="#" class="list-group-item">'
              + '<div class="media">'
              +    '<div class="pull-left">'
              +        '<img class="img-circle img-offline" src="<?=base_url();?>'+contractors[i]['PROFILE_IMG_URL']+'" alt="...">'
              +    '</div>'
              +    '<div class="media-body">'
        ...
        for (var i = 0; i < supervisors.length; i++) {
          b += '<a href="#" class="list-group-item">'
              + '<div class="media">'
              +    '<div class="pull-left">'
              +        '<img class="img-circle img-offline" src="<?=base_url();?>'+supervisors[i]['PROFILE_IMG_URL']+'" alt="...">'
              +    '</div>'
              +    '<div class="media-body">'
