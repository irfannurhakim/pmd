<div class="container-dt">
  <table id="table-list-reports" class="table table-bordered responsive table-hover">
    <thead class="">
      <tr>
        <th>Nama Proyek</th>
        <th>Kontraktor</th>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    jQuery('#table-list-reports tbody').on( 'click', 'tr', function () {
      var id = $(this).attr('object');
      window.location = "<?=base_url();?>#/weekly_report/detail/" + id;
    });
